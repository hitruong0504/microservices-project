package com.hitruong.OrderService.controller;
...
import com.hitruong.OrderService.OrderServiceConfig;
...
import com.hitruong.OrderService.service.OrderService;
...
public class OrderControllerTest {
    ...
    public void test_WhenPlaceOrder_DoPayment_Success() throws Exception {
        //1. Place order
        //2. Get Order by Order Id from db and check
        //3. check output
    ...
    @Test
    public void test_WhenPlaceOrder_WithWrongAccess_thenThrow403() throws Exception {
        OrderRequest orderRequest = getMockOrderRequest();
        MvcResult result
                = mockMvc.perform(MockMvcRequestBuilders.post("/order/placeOrder")
    ...
    @Test
    public void test_WhenGetOrder_Order_NotFound() throws Exception {
        MvcResult result
